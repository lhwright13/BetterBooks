...
class TTSServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SynthesizeSpeech = channel.unary_unary(
                '/betterbooks.tts.TTSService/SynthesizeSpeech',
...
def add_TTSServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'betterbooks.tts.TTSService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('betterbooks.tts.TTSService', rpc_method_handlers)
