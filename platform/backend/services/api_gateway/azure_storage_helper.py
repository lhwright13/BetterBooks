...
class AzureStorageHelper:
    ...
    def _generate_sas_url(self, container_name: str, blob_name: str, expiry_hours: int) -> Optional[str]:
        if not self.enabled:
            return None
    ...
    def check_file_exists(self, file_path: str) -> bool:
        ...
        try:
            blob_client = self.blob_service_client.get_blob_client(container="audiobooks", blob=file_path)
    ...
    def upload_audio_file(self, local_file_path: str, blob_path: str) -> bool:
        ...
        try:
            blob_client = self.blob_service_client.get_blob_client(container="audiobooks", blob=blob_path)
    ...
    def upload_cover_image(self, local_file_path: str, blob_path: str) -> bool:
        ...
        try:
            blob_client = self.blob_service_client.get_blob_client(container="covers", blob=blob_path)
