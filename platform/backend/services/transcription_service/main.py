...
# Core modules are available via PYTHONPATH environment variable

# Import from organized core modules
from core.ai.chapter_detection import (
...
from core.ai.question_generation import (
        ...
        try:
            ...
            if temp_file_name and os.path.exists(temp_file_name):
                try:
                    ...
                    logger.warning(f"Failed to cleanup temp file {temp_file_name}: {cleanup_error}")
